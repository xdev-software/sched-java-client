...
import software.xdev.sched.client.auth.Authentication;
import software.xdev.sched.client.auth.ApiKeyAuth;

@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class ApiClient extends JavaTimeFormatter {
  private Map<String, String> defaultHeaderMap = new HashMap<String, String>();
  private Map<String, String> defaultCookieMap = new HashMap<String, String>();
  private String basePath = "https://xdevtest1.sched.com";
  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://{conference}.sched.com",
      "No description provided",
      new HashMap<String, ServerVariable>() {{
        put("conference", new ServerVariable(
          "Conference",
          "xdevtest1",
          new HashSet<String>(
          )
